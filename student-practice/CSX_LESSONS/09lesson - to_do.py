...
for curve_grade in grades:
    print(f"Student #{grades.index(curve_grade) + 1} recieved a grade of {curve_grade +3}")
...
for day in temperature_forecast:
  print(f"On {day} it will be {temperature_forecast[day]} outside")